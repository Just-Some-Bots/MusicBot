...
class MusicBot(discord.Client):
    ...
    async def handle_shuffle(self, message, player):
        """
        ...
        return Response('*Queue Shuffled!*', delete_after=10)

    async def handle_next(self, player, channel, author):
        """
        Usage {command_prefix}next
        Skips the current song if you're the bot owner.
        """
