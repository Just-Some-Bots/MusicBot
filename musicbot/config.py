...
class Config:
    def __init__(self, config_file):
        ...
        self.config.saved_playlist_file = config.get('Files', 'SavedPlaylistFile', fallback=ConfigDefaults.saved_playlist_file)
...
class ConfigDefaults:
    ...
    saved_playlist_file = 'config/savedplaylist.txt'
