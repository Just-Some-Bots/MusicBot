> :loudspeaker: discord.py 가 다시 작성되는 동안, 이 봇은 주요 업데이트를 받지 못할 것 입니다. 프로젝트가 죽더라도 저희에게 버그 리포팅을 하지 말아주세요. discord.py 파일에 대한 업데이트로 인해 어느 시점에서 잠시 쉴 가능성이 높습니다. discord.py의 재작성이 끝난다면, 이 봇 또한 다시 작성될 것입니다.
