...
class Config:
    def __init__(self, config_file):
        ...
        if not config.read(config_file, encoding='utf-8'):
            print('[%s][WARNING] Config file not found, copying example_options.ini' % datetime.datetime.now())
        ...
        self.prefixes_file = config.get('Files', 'PrefixesFile', fallback=ConfigDefaults.prefixes_file)
    ...
    def run_checks(self):
        ...
        if self.bound_channels:
            try:
                ...
                print("[%s][WARNING] BindToChannels data invalid, will not bind to any channels" % datetime.datetime.now())
        ...
        if self.autojoin_channels:
            try:
                ...
                print("[%s][WARNING] AutojoinChannels data invalid, will not autojoin any channels" % datetime.datetime.now())
