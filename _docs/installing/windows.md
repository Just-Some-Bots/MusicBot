...
1. Install [Python 3.9](https://www.python.org/ftp/python/3.9.1/python-3.9.1.exe).
2. During the setup, tick `Install launcher for all users (recommended)` and `Add Python 3.9 to PATH` when prompted.
